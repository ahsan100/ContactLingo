...
/**
 * Created by ahsanmanzoor on 21/02/2016.
 */

public class Provider_Email extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getPackageName() + ".provider.email";
        ...
        tableMap.put(BasicData.EMAIL, BasicData.EMAIL);
    ...
    public static final class BasicData implements BaseColumns {
        private BasicData(){};
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/email");
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.contactlingo.email";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.contactlingo.email";
        public static final String _ID = "_ID";
        public static final String EMAIL = "contact";
        public static final String FIRST_LANG = "first_lang";
        public static final String SECOND_LANG = "second_lang";

    }

    public static final String[] DATABASE_TABLES = { "email" };
    public static final String[] TABLES_FIELDS = {
            BasicData._ID + " integer primary key autoincrement,"
                    + BasicData.EMAIL + " text default '',"
    ...
    public Uri insert(Uri uri, ContentValues new_values) {
        ...
        switch (sUriMatcher.match(uri)) {
            case MESSAGE:
                long _id = database.insert(DATABASE_TABLES[0], BasicData.EMAIL, values);
                if (_id > 0) {
