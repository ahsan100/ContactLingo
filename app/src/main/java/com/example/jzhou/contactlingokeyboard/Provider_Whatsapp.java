...
public class Provider_Whatsapp extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getPackageName() + ".provider.whatsapp";
    ...
    public static final class BasicData implements BaseColumns {
        private BasicData(){};
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/whatsapp");
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.contactlingo.whatsapp";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.contactlingo.whatsapp";
    ...
    public static final String[] DATABASE_TABLES = { "whatsapp" };
